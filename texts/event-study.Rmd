...
Event1 = feglm(UNINS ~ i(ttot, expansion, ref = -1)|                 
                       ST + YEAR,                             ## FEs
               cluster = ~ST,                          ## Clustered SEs
               weights = ~PWGTP,
               data = NATV, family = 'logit')

Event2 = feglm(UNINS ~ i(ttot, expansion, ref = -1)+.[controls]|                 
                       ST + YEAR,                             ## FEs
               cluster = ~ST,                          ## Clustered SEs
               weights = ~PWGTP,
               data = NATV, family = 'logit')

Event3 = feglm(UNINS ~ i(ttot, expansion, ref = -1)|                 
                       ST + YEAR,                             ## FEs
               cluster = ~ST,                          ## Clustered SEs
               weights = ~PWGTP,
               data = Forgn, family = 'logit')

Event4 = feglm(UNINS ~ i(ttot, expansion, ref = -1)+.[controls] + .[foriegn]|                 
                       ST + YEAR,                             ## FEs
               cluster = ~ST,                          ## Clustered SEs
               weights = ~PWGTP,
               data = Forgn, family = 'logit')
...
Event5 = feglm(HINS4 ~ i(ttot, expansion, ref = -1)|                 
                       ST + YEAR,                             ## FEs
               cluster = ~ST,                          ## Clustered SEs
               weights = ~PWGTP,
               data = NATV , family = 'logit')

Event6 = feglm(HINS4 ~ i(ttot, expansion, ref = -1)+.[controls]|                 
                       ST + YEAR,                             ## FEs
               cluster = ~ST,                          ## Clustered SEs
               weights = ~PWGTP,
               data = NATV , family = 'logit')
...
Event7 = feglm(HINS4 ~ i(ttot, expansion, ref = -1)|                 
                       ST + YEAR,                             ## FEs
               cluster = ~ST,                          ## Clustered SEs
               weights = ~PWGTP,
               data = Forgn , family = 'logit')

Event8 = feglm(HINS4 ~ i(ttot, expansion, ref = -1)+.[controls] + .[foriegn]|                 
                       ST + YEAR,                             ## FEs
               cluster = ~ST,                          ## Clustered SEs
               weights = ~PWGTP,
               data = Forgn , family = 'logit')
