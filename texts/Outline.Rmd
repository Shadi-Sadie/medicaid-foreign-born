...
Event2 = feols(UNINS ~ i(ttot, expansion, ref = -1)+.[controlwof]|                 
                       ST + YEAR,                             ## FEs
               vcov= "hetero" ,
               weights = ~PWGTP,
               data = NATV)
...
Event4 = feols(UNINS ~ i(ttot, expansion, ref = -1)+.[controlwof] + .[forcont]|                 
                       ST + YEAR,                             ## FEs
               vcov="hetero" ,
               weights = ~PWGTP,
               data = Forgn)
...
Event8 = feols(HINS4 ~ i(ttot, expansion, ref = -1)+ ADA +.[controls] +.[forcont]|                 
                       ST + YEAR,                             ## FEs
               vcov = "hetero" ,
               weights = ~PWGTP,
               data = Forgn)
...
reg2 = feols(UNINS ~ treat*ForeginBorn + .[NICont] +.[Intcontrol] | ST + YEAR , vcov = "hetero", weights = ~PWGTP, data = data) # state and 

reg3 = feols(UNINS ~treat*ForeginBorn + .[NICont] + .[Intcontrol] | ST + YEAR + REGION^YEAR , vcov = "hetero", weights = ~PWGTP, data = data) # state and year fixed effect

reg4 = feols(UNINS ~ treat*ForeginBorn + .[NICont] + ForeginBorn*(SCHLG+ MARG+ RACE1 + ESRG + ADA) | ST + YEAR , vcov = "hetero", weights = ~PWGTP, data = data) # state and 


reg5 = feols(UNINS ~ treat*ForeginBorn + .[NICont] + ForeginBorn*(SCHLG+ MARG+ RACE1 + ESRG + ADA) | ST + YEAR , vcov = "hetero", weights = ~PWGTP, data = data) # state and 
...
reg2 = feols(HINS4 ~ treat*ForeginBorn + .[NICont] + .[Intcontrol]| ST + YEAR , vcov = "hetero", weights = ~PWGTP, data = data) # state and 

reg3 = feols(HINS4 ~treat*ForeginBorn + .[NICont] + .[Intcontrol]| ST + YEAR + REGION^YEAR , vcov = "hetero", weights = ~PWGTP, data = data) # state and year fixed effect

reg4 = feols(HINS4 ~ treat*ForeginBorn + .[NICont] + ForeginBorn*(SCHLG+ MARG+ RACE1 + ESRG + ADA) | ST + YEAR , vcov = "hetero", weights = ~PWGTP, data = data) # state and 


reg5 = feols(HINS4 ~ treat*ForeginBorn + .[NICont] + ForeginBorn*(SCHLG+ MARG+ RACE1 + ESRG + ADA) | ST + YEAR + REGION^YEAR , vcov = "hetero", weights = ~PWGTP, data = data) # state and 
...
```{r plotbac, fig.height = 5 , fig.width = 7}
library(cowplot)
